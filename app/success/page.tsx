    ...
    <section className='bg-gradient-to-br from-green-50 to-green-100 px-6 py-20 text-center'>
        <div className='max-w-3xl mx-auto space-y-8'>
            ...
            <div className='flex flex-col sm:flex-row justify-center gap-4 pt-4'>
                ...
                <Link
                    href="/"
                    className='inline-block px-6 py-3 rounded-full bg-white text-green-700 border border-green-700 text-base font-medium hover:bg-green-50 transition duration-300'
                >
                    Continue Shopping
                </Link>
            </div>
